...
m\a=0x80000000>>b\a;.endif;.endr;.endm;.macro enumb.mask,va:vararg;i=0;.irp a,\va;ifdef \a;
.if ndef;\a=0;.endif;ifdef m\()\a;.if ndef;m\()\a=0;.endif;i=i|(m\a&(\a!=0));.endr;enumb.mask=i;
enumb.crf=0;.rept 8;enumb.crf=(enumb.crf<<1)|!!(i&0xF);i=i<<4;.endr;.endm;enumb.count=31;
enumb.step=-1;.endif
