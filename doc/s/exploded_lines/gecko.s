...
.if module.included == 0
  ...
  .macro gecko.inj,  address
    ...
    gecko.__start = .
  .endm;
  .macro gecko.ovw,  address,  va:vararg
    gecko.end
    gecko.__altm = alt
    ifalt
    gecko.__alt = alt
    ...
    .noaltmacro
    gecko.__ovw, \va
    ifalt.reset gecko.__alt
    alt = gecko.__altm
  .endm;
  .macro gecko.__ovw,  arg,  va:vararg
    .ifnb \arg
    ...
    .endif;
  .endm;
  .macro gecko.__ovw_alt,  arg,  va:vararg
    gecko.__i = 0
    gecko.__quote = 0
    .irpc c,  <\arg>
      .if gecko.__i
    ...
    .endr;
  .endm;
  .macro gecko.__ovw_check,  arg,  va:vararg
    ifnum \arg
  .endm;
  .macro gecko.__ovw_va,  va:vararg
    .ifnb \va
      .long 0x04000000 | (0x01FFFFFF & gecko.__target)
      \va
    .endif;
