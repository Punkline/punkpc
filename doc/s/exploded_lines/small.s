...
.if module.included == 0
  ...
  .macro small.__instr_build,  rlw
    .macro \rlw,  va:vararg
      small.__instr_handle \rlw, \va
    .endm;
  .endm;
  .macro small.__instr_handle,  va:vararg
    small.__altm = alt
    ifalt
    small.__alt = alt
    .noaltmacro
    small.__instr \va
    ifalt.reset small.__alt
    alt = ifalt.__altm
  .endm;
  .macro small.__instr,  rlw,  d,  a,  m,  va:vararg
    ...
    .ifnb \va
      \rlw \d, \a, (\m)&31, \va
    .else;
      small.__instr_logic \rlw, \d, \a, \m
    .endif;
    small.__instr_build \rlw
  .endm;
  .macro small.__instr_logic,  rlw,  d,  a,  m
    small.__beg = 0
    small.__end = 0
    small.__rot = 0
    small.__inv = 0
