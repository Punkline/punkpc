...
.if module.included == 0
  ...
  .macro mut.class,  class,  mut_ns=mut,  hook_ns=hook
    ...
    .if ndef
      ...
      .endm;
      .macro \class\().purge_hook,  obj,  va:vararg
        .irp hook,  \va
  ...
  .macro mut.mut,  mut,  hook,  obj,  hook_ns=hook
    ...
    \obj\().\hook_ns\().\hook\().purgable = 1
  .endm;
  .macro mut.mode,  mode=default,  hook,  obj,  class,  mut_ns=mut,  hook_ns=hook
    mut.purge_hook \hook, \obj, \hook_ns
    ...
    .if ndef
      mut.mutable_mode$ = mut.mutable_mode$ + 1
    ...
    \obj\().\hook_ns\().\hook\().purgable = 1
  .endm;
  .macro mut.call,  obj,  hook,  mode,  class,  mut_ns=mut,  hook_ns=hook,  va:vararg
    ...
    .endif;
  .endm;
  .macro mut.purge_hook,  hook,  obj,  hook_ns=hook
