...
.ifndef spr.included; spr.included = 0; .endif; .ifeq spr.included; spr.included = 1
.include "./punkpc/idxr.s"  # allows us to capture and use idx(r) inputs
.include "./punkpc/xem.s"   # includes some default register names that we can use in idxr
